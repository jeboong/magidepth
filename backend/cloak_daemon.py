"""MagiCloak JSON-lines worker. No PySide6, torch, or media upload required."""
...
from cloak.engine import CloakEngine as Engine, probe
...
def main():
    ...
    jobs = {}
    engine = Engine()
    worker = concurrent.futures.ThreadPoolExecutor(max_workers=1, thread_name_prefix='cloak-processing')
