...
**설치:** https://github.com/jeboong/magidepth/releases/tag/v0.3.3

`MagiMagic-Setup-0.3.3.exe` 실행 → 시작하기 → 얼굴 왼쪽 Depth / 오른쪽 Cloak을 선택하면 됩니다. Depth 기본 모델은 최초 셋업에 포함되고, 나머지 AI 맵은 필요한 모델만 다운로드한 뒤 선택하세요.
...
- 고정 버전 설치 파일: https://github.com/jeboong/magidepth/releases/download/v0.3.3/MagiMagic-Setup-0.3.3.exe
