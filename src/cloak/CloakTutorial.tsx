...
const steps = [
  ...
  },
  {
    icon: Grid2X2,
    title: "매지코의 격자 장난.",
    body: "A · Face Grid가 기본 주문입니다. 자동 검출·추적을 끄면 수동 격자를 최대 16개 추가할 수 있어요. 격자를 끌어서 이동하고 네 모서리로 크기를 조절하세요. 화면에서 즉시 움직이고 손을 놓으면 정확한 결과가 계산됩니다. 선택 후 Delete로 지울 수 있습니다.",
  },
  {
    icon: Sparkles,
    title: "세 가지 작은 변주.",
  ...
  },
  {
    ...
    title: "품질과 길이까지 챙겨요.",
    body: "원본품질·표준·작은파일 중 고르세요. 원본품질은 CRF 14 고품질 인코딩이며 원본 픽셀과 완전히 같은 무손실을 뜻하지 않습니다. 원본 오디오는 가능한 경우 유지합니다. 짧은 영상은 지정 길이까지 앞 또는 뒤에 검정 화면과 무음을 추가할 수 있어요.",
  },
  {
    icon: Download,
    title: "폴더에 가지런히 담아두기.",
